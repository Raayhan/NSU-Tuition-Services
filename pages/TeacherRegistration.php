      ...
      <div class="container-fluid register mt-0">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <form action="TeacherLogin.php" method="get">
                    ...
                    <div class="col-md-9 register-right">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="StudentRegistration.php" role="tab" aria-controls="profile" aria-selected="false">Student</a>
                            </li>
                        </ul>
